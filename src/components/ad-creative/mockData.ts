...
export const MOCK_WRITER_RESULT = {
  ...
  copies: [
    { id: 1, tone: "공감형", headline: "오늘 하루, 피부에게", subheadline: "바쁜 하루 끝, 조용히 나를 돌보는 시간", body: "퇴근 후 거울 앞에 서면, 그제야 오늘 내 얼굴이 보인다. 슬로우 뷰티 루틴으로 나만의 저녁을 시작해보세요.", cta: "루틴 시작하기", visual_direction: "따뜻한 침실 조명 아래 세럼을 바르는 손 클로즈업" },
    { id: 2, tone: "친근", headline: "피부과? 나는 집에 있어", subheadline: "굳이 예약 안 해도 되는 이유", body: "대기 번호 37번. 결국 점심도 못 먹었다. 근데 사실 비건 루틴 다 끝냈다. 뭔가 이겼다는 느낌?", cta: "홈케어 보러가기", visual_direction: "대기실 캐릭터 vs 홈케어 캐릭터 대비 일러스트" },
    { id: 3, tone: "후기형", headline: "그 사람 피부, 뭔가 달랐다", subheadline: "물어봤더니 딱 한 가지라고 했다", body: "매일 마주치는 그 동료. 화장을 더 한 건 아닌데... 용기 내서 물어봤더니 대답은 단순했다.", cta: "정답 확인하기", visual_direction: "흐릿한 인물 실루엣 + 헤드라인 텍스트 강조" },
    { id: 4, tone: "정보형", headline: "잠들기 전, 3분의 의식", subheadline: "아무것도 하기 싫은 밤에도 이것만은", body: "하루의 끝, 나를 위한 루틴. 세럼 한 방울에 오늘의 스트레스가 녹는다.", cta: "3분 루틴 보기", visual_direction: "야간 침실 조명, 세럼 드롭 매크로 샷" },
    { id: 5, tone: "긴급형", headline: "좋은 피부는 타고나는 거 아닙니다", subheadline: "유전자 탓은 이제 그만", body: "피부는 습관의 결과물. 과학적으로 설계된 루틴이 당신의 피부를 바꿉니다.", cta: "루틴 설계하기", visual_direction: "Before/After 스플릿 구도, 클린한 스튜디오 배경" },
  ]
};

export const MOCK_DESIGN_RESULT = {
  copy_id: 1, tone: "공감형", headline: "오늘 하루, 피부에게",
  cuts: [
